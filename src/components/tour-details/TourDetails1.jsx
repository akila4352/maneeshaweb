    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          <p>
            Our mission is to satisfy the needs of our customers, promote memorable holidays in Sri Lanka, and provide service in a socially and environmentally responsible way.
          </p>
          <h3 style={{ color: "#FEA116", marginBottom: "1rem" }}>Routes</h3>
          <ul>
            {pkg.routes.map(route => <li key={route}>{route}</li>)}
          </ul>
        ...
        <div style={
          ...
          <BookingCard
            ...
            days={pkg.pricing.days}
            destination={pkg.pricing.destination}
            onBook={handleBook}
          />
        </div>
      </div>
