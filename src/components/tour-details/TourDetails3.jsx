...
export default function TourDetails3() {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <h2 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>Sri Lanka Tour 3 Days</h2>
          ...
          <p>
            Discover the southern gems of Galle and Matara with a professional guide.
          </p>
        ...
        <div style={
          ...
          <BookingCard price={180.00} days={3} destination="Galle, Matara" onBook={handleBook} />
        </div>
      </div>
    </>
  );
